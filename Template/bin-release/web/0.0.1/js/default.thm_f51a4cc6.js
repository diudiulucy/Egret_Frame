...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	function Hall() {
		...
		this.height = 720;
		this.width = 1280;
		this.elementsContent = [this._Image1_i(),this.player_i(),this._List1_i(),this._DataGroup1_i(),this.virtuallayout_i(),this.virtual_i(),this.btn_new_i(),this._Scroller1_i(),this.bottom_i(),this._Rank1_i(),this._Image4_i()];
	}
	...
	return testRender;
})(eui.Skin);generateEUI.paths['resource/views/login/LoginLayer.exml'] = window.Skin.LoginLayer = (function (_super) {
	...
	_proto._Group1_i = function () {
		...
		t.horizontalCenter = 0;
		t.verticalCenter = 0;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this._Image3_i(),this.btn_close_i(),this._Scroller1_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
