...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	var SettingLayer$Skin1 = 	(function (_super) {
		__extends(SettingLayer$Skin1, _super);
		function SettingLayer$Skin1() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = SettingLayer$Skin1.prototype;
	...
	var RuleLayer$Skin2 = 	(function (_super) {
		__extends(RuleLayer$Skin2, _super);
		function RuleLayer$Skin2() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = RuleLayer$Skin2.prototype;
