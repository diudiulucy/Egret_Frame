...
generateEUI.paths['resource/eui_skins/ButtonSkin.exml'] = window.skins.ButtonSkin = (function (_super) {
	...
	var Shop$Skin2 = 	(function (_super) {
		__extends(Shop$Skin2, _super);
		function Shop$Skin2() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = Shop$Skin2.prototype;
	...
	var SettingLayer$Skin3 = 	(function (_super) {
		__extends(SettingLayer$Skin3, _super);
		function SettingLayer$Skin3() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = SettingLayer$Skin3.prototype;
